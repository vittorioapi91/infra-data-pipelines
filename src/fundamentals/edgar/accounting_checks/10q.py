...
Rules are loaded from src/fundamentals/edgar/rules-xbrl/10q.yaml.
"""
...
def _load_rules() -> Dict[str, Any]:
    """Load 10-Q rules from src/fundamentals/edgar/rules-xbrl/10q.yaml."""
    mod_dir = Path(__file__).resolve().parent.parent  # edgar/
    rules_path = mod_dir / "rules-xbrl" / "10q.yaml"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: accounting_checks/10q.py <path/to/accession-code.json>", file=sys.stderr)
        sys.exit(1)
